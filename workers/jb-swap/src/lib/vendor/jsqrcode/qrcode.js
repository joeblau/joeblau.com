...
// @ts-nocheck
//
// Vendored from https://github.com/LazarSoft/jsqrcode (Apache-2.0, 2011 Lazar
// Laszlo) — itself a port of the ZXing qrcode scanner
// (https://github.com/zxing/zxing). The upstream Apache-2.0 NOTICE/copyright
// headers are preserved inline below, per §4(c) of the license.
//
// The 17 upstream source files are concatenated in the order the upstream
// README specifies, then wrapped in a factory function so none of the
// decoder's ~50 globals (qrcode, Detector, Decoder, BitMatrix, GF256,
// FinderPatternFinder, L/M/Q/H, MIN_SKIP, ...) escape into module scope.
// Each call to createQrcode() returns a fresh, isolated qrcode instance.
//
// No functional edits to the upstream code — the only change is the wrapper
// header/footer and the per-file separator banners.
