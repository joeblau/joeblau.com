      ...
      <div className="relative py-16 overflow-hidden">
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="text-lg max-w-prose mx-auto">
            <div className="text-lg mx-auto primary-prose">
              ...
              <ul>
                <li>
                  <p>
                    ...
                    any electronic device, named Doodle Draw Pad
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    ...
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Doodle Draw Pad.
                  </p>
                </li>
                <li>
                  <p>
              ...
              <ul>
                <li>
                  ...
                  <a href="https://doodle.app" rel="external nofollow noopener">
                    https://doodle.app
                  </a>
                </li>
              </ul>
